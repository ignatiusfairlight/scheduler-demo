...
<Dialog.Root>
  ...
  <Dialog.Content>
    ...
    <Dialog.Footer class="mt-4 flex justify-end gap-2">
      ...
      <Dialog.Close
        class="inline-flex items-center justify-center gap-2 h-9 px-4 py-2 rounded-md text-sm font-medium bg-red-600 text-white border border-red-600 shadow-xs whitespace-nowrap transition-all outline-none hover:bg-red-700 hover:border-red-700 focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
      >
        Cancel
      </Dialog.Close>
    </Dialog.Footer>
